...
[![Live Tool](https://img.shields.io/badge/Live%20Tool-yuledev.github.io-blue)](https://yuledev.github.io/FLT_Mountain_Wave_Calc/)
[![FAA Reference](https://img.shields.io/badge/FAA%20Reference-FAA--H--8083--28-green)](https://www.faa.gov/regulations_policies/handbooks_manuals/aviation)
[![ACS Standards](https://img.shields.io/badge/ACS-PA.I.B.K3%20%7C%20PA.II.A%20%7C%20PA.X.A-orange)](https://www.faa.gov/training_testing/testing/acs)
...
It operationalizes the go/no-go math that most pilots know they *should* do but rarely do systematically: wave ratio, Froude Number regime, terrain relief, ridge-top wind speed, and stability layer assessment — combined into a single, structured preflight check.
...
None of BOAC Speedbird 911 (124 killed, Mt. Fuji, 1966) or JAL/Evergreen 46E (engine separated, Anchorage, 1993) were caused by a lack of available information. They were caused by not acting on it. This tool forces the act of checking.

---

## What the Calculator Does

The calculator guides the pilot through a structured **5-step Wasatch Wave Check**, computing risk indicators at each step:
...
```
Fr = Wind Speed ÷ (Brunt-Väisälä frequency × Mountain Height)
```
The calculator classifies the flight into one of three regimes:

| Fr | Regime | What to Expect |
|---|---|---|
| Fr < 1 | Mountain Wins (Blocking) | Rotors near ridge altitude, mechanical turbulence, windward updrafts |
| Fr ≈ 1 | **Maximum Danger (Resonance)** | 3,000+ fpm vertical drafts, severe rotor, altimeter errors 500–2,000 ft — **NO-GO** |
| Fr > 1 | Wind Wins (Shooting Flow) | Extreme downslope winds, hydraulic jump on valley floor, Vno exceedance risk |

### Step 4 — Go/No-Go Advisory Ladder
Evaluates active weather products and outputs a structured go/no-go recommendation:

| Product | Action |
|---|---|
| **G-AIRMET Tango** active on route | Caution — apply full wave check before departure |
| **Non-convective SIGMET (WS)** active | **No-go for all light aircraft. Not a judgment call.** |
| Moderate+ **PIREP** on your route | Treat as a personal warning — go/no-go review required |
| Skew-T shows stable layer at ridge level | High N (Brunt-Väisälä) — expect organized, amplified wave |

### Step 5 — Weight-Adjusted Maneuvering Speed (Va)
```
Va (adjusted) = Va (max gross) × √(Current Weight ÷ Max Gross Weight)
```
Lighter aircraft break at lower Va. A solo SportCruiser or DA20 on partial fuel has significantly less structural margin than the same aircraft at max gross. The calculator outputs your adjusted Va and warns if you are operating in a high-risk weight regime.
...
This tool and its companion briefing are grounded in published FAA standards:
...
| **SIGMET (WS)** | Severe/extreme turbulence, severe icing, volcanic ash | ✅ Active SIGMET = no-go for light aircraft |
...
- Locate G-AIRMET Tango, non-convective SIGMET WS, and PIREPs on [aviationweather.gov](https://aviationweather.gov) and correctly identify go/no-go triggers
...
| Resource | Link |
|---|---|
| FAA Aviation Weather Handbook (FAA-H-8083-28) | [faa.gov](https://www.faa.gov/regulations_policies/handbooks_manuals/aviation) |
...
| NTSB Aviation Accident Database | [ntsb.gov](https://www.ntsb.gov/aviation) |
| Utah Soaring Association (Wasatch wave expertise) | [utahsoaring.org](https://utahsoaring.org) |
| KSLC Skew-T Sounding | [aviationweather.gov/upperair](https://aviationweather.gov/upperair/graph?region=slc) |
...
The wave ratio heuristic used in this calculator is an informal decision aid — not a certified meteorological formula. Always cross-reference with official G-AIRMET, SIGMET, and PIREP data from aviationweather.gov.
